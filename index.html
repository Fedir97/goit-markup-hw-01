...
<body>
    ...
    <header>
        <nav>
            <a href="">
                <img src="./images/logo.jpg" alt="logo" width=""/>
            </a>
            <ul>
    ...
    <section>
        ...
        <ul>
            <li><img src="./images/first.jpg" alt="" width="" /></li>
            <li><img src="./images/second.jpg" alt="" width="" /></li>
            <li><img src="./images/third.jpg" alt="" width="" /></li>
        </ul>
    </section>
    ...
    <section>
        <h2>Наша команда</h2>
        <ul>
            <li><img src="./images/img (2).jpg" alt="Product Designer" width="" />
                <h3>Игорь Демьяненко</h3>
                <p lang="en">Product Designer</p>
            </li>
            <li><img src="./images/img (3).jpg" alt="Frotend Developer" width="" />
                <h3>Ольга Репина</h3>
                <p lang="en">Frontend Developer</p>
            </li>
            <li><img src="./images/img (4).jpg" alt="Marketing" width="" />
                <h3>Николай Тарасов</h3>
                <p lang="en">Marketing</p>
            </li>
            <li><img src="./images/img (5).jpg" alt="UI Designer" width="" />
