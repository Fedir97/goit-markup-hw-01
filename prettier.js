                ...
                <meta http-equiv="X-UA-Compatible" content="IE=edge">
                    ...
                    <body>
                        ...
                        <section>
                            ...
                            <ul>
                                <li><img src="./images/first.jpg" alt="" /></li>
                        ...
                        <section>
                            <h2>Наша команда</h2>
                            <ul>
                                <li><img src="./images/img (2).jpg" alt="Игорь Демьяненко" />
                                    <h3>Игорь Демьяненко</h3>
                                    <p lang="en">Product Designer</p>
                                </li>
                                <li><img src="./images/img (3).jpg" alt="Ольга Репина" />
                                    <h3>Ольга Репина</h3>
                                    <p lang="en">Frontend Developer</p>
                                </li>
                                <li><img src="./images/img (4).jpg" alt="Николай Тарасов" />
                                    <h3>Николай Тарасов</h3>
                                    <p lang="en">Marketing</p>
                                </li>
                                <li><img src="./images/img (5).jpg" alt="Михаил Ермаков" />
